...
def main(decimal_string):
    ...
    I1 <<= 13    # Размещаем I1 на позиции с 12 по 14
    I2 <<= 16    # Размещаем I2 на позиции с 16 по 17
    I3 <<= 0     # Размещаем I3 на позиции с 0 по 5
    I4 <<= 17    # Размещаем I4 на позиции с 18 по 22
    I5 <<= 7     # Размещаем I5 на позиции с 6 по 11
