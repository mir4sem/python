...
# 10 вариант
![image](https://github.com/mir4sem/python/assets/70198995/9ce4b5e1-13a1-42d4-b07f-d866cc212d07)

```python
def main(decimal_string):
    # Преобразуем входную десятичную строку в целое число
    number = int(decimal_string)
    
    # Извлекаем значения битовых полей с помощью побитовых операций
    Q1 = (number >> 0) & 0x3F    # Извлекаем 6 бит (с 0 по 5)
    Q2 = (number >> 6) & 0x1F    # Извлекаем 5 бит (с 6 по 10)
    Q3 = (number >> 11) & 0x1FF  # Извлекаем 9 бит (с 11 по 19)
    Q4 = (number >> 20) & 0x3F   # Извлекаем 6 бит (с 20 по 25)
    Q5 = (number >> 26) & 0x7F   # Извлекаем 7 бит (с 26 по 32)
    Q6 = (number >> 33) & 0x1FF  # Извлекаем 9 бит (с 33 по 41)
...
# Тесты
print(main('690842418230'))  # Ожидается: {'Q1': '54', 'Q2': '0', 'Q3': '175', 'Q4': '45', 'Q5': '27', 'Q6': '80'}
print(main('95275629226'))   # Ожидается: {'Q1': '42', 'Q2': '10', 'Q3': '430', 'Q4': '219', 'Q5': '5', 'Q6': '11'}
print(main('1663803078110')) # Ожидается: {'Q1': '30', 'Q2': '7', 'Q3': '269', 'Q4': '76', 'Q5': '44', 'Q6': '193'}
print(main('779977109898'))  # Ожидается: {'Q1': '10', 'Q2': '6', 'Q3': '140', 'Q4': '72', 'Q5': '51', 'Q6': '90'}
```

# 11 вариант
![image](https://github.com/mir4sem/python/assets/70198995/f83a6dc7-9b9e-42a8-a795-20158d295e7f)
...
def main(decimal_string):
    ...
    # Извлекаем значения битовых полей из входного числа
    I1 = (number >> 0) & 0x7
    I2 = (number >> 3) & 0x1
    I3 = (number >> 4) & 0x7F
    I4 = (number >> 11) & 0x3F
    ...
    # Размещаем значения битовых полей в новом порядке
    new_number = 0
    new_number |= (I1 << 13)    # Размещаем I1 на позиции с 12 по 14
    new_number |= (I2 << 16)    # Размещаем I2 на позиции с 16 по 17
    new_number |= (I3 << 0)     # Размещаем I3 на позиции с 0 по 5
    new_number |= (I4 << 17)    # Размещаем I4 на позиции с 18 по 22
    new_number |= (I5 << 7)     # Размещаем I5 на позиции с 6 по 11

    # Возвращаем результат в виде десятичной строки
    return str(new_number)

# Тесты
print(main('641066'))    # Ожидается: '7553538'
print(main('4676504'))   # Ожидается: '5706169'
print(main('4208178'))   # Ожидается: '807011'
print(main('7292728'))   # Ожидается: '5315571'
```
